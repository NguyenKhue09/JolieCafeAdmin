...
sealed class NotificationFormStateEvent {
    ...
    data class OnProductNameChanged(val productName: String) : NotificationFormStateEvent()
    data class OnVoucherIdChanged(val voucherId: String) : NotificationFormStateEvent()
    data class OnVoucherCodeChanged(val voucherCode: String) : NotificationFormStateEvent()
